            ...
            <div class="clear m-2">
              ...
              <div class="row">
                ...
                <h4 class="m-0 text-xs _300 p-2"><a href="#">Colores 1</a></h4>
                  <nav aria-label="...">
                    <ul class="pagination">
                      <li class="teal-500"><a class="page-link" href="#">A</a></li>
                      <li class="lime-50"><a class="page-link" href="#">B</a></li>
                      <li class="indigo-500"><a class="page-link" href="#">C</a></li>
                ...
                <h4 class="m-0 text-xs _300 p-2"><a href="#">Colores 2</a></h4>
                  <nav aria-label="...">
                  <ul class="pagination">
                      <li class="red-400"><a class="page-link" href="#">A</a></li>
                      <li class="lime-50"><a class="page-link" href="#">B</a></li>
                      <li class="purple-300"><a class="page-link" href="#">C</a></li>
          ...
          <div class="box p-a">
            <div class="pull-left m-r p-2">
              <span class="w-32 rounded pink-200">
                <i class="material-icons">&#xe0c9;</i>
              </span><span class="input-group-text"> Mensaje</span>
            </div>
              ...
              <div class="streamline b-l m-l">
                ...
                <div class="sl-item b-warning">
                  <div class="sl-content">
                    ...
                    <div><a href class="text-info">Jessi</a> assign you a task <a href class="text-info">Mockup
                        Design</a>.</div>
                  </div>
                </div>
              </div>
